...
# Nombre de usuario y contraseña para el servidor MySQL local
user = input("Ingresa el nombre de usuario de MySQL: ")
...
#definir variable
borrar = bool
# Menú de selección para eliminar o no la base de datos existente
while True:
...
try:
    connection = mysql.connector.connect(**configura_base)

    if connection.is_connected():
        print("Conexión exitosa")


    if configura_base.get('borrar'):

        # Eliminar la base de datos si se selecciona
